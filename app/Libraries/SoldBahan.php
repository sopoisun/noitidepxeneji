...
class SoldBahan extends Fpdf{
    ...
    public function WritePage()
    {
        ...
        $this->Cell(95, 8, "Nama Bahan", 1, 0);
        $this->Cell(35, 8, "Harga (Avg)", 1, 0);
        ...
        $this->Cell(35, 8, number_format(collect($this->data)->sum('subtotal'), 0, ',', '.'), 1, 1, 'R');
